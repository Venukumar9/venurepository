...
public class LeaveApplication extends HttpServlet{
	 ...
	 PreparedStatement ps=null;
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			String degisnation=request.getParameter("degisnation");
			...
			ps=connect.prepareStatement("insert into empleaves(ename,empid,degisnation,fromdate,todate,days,reason,mname,status) values(?,?,?,?,?,?,?,?,?)");
